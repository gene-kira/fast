...
class GuardianGUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.status_panel.setStyleSheet("border: 1px solid #00ffe7; padding: 6px;")
    ...
    def cinematic_boot(self):
        self.log_view.setText("🧿 Initializing MAGICBOX GUARDIAN...\nPersona loading: Baurdan\nLoading glyph protocol...")
        QTimer.singleShot(2500, lambda: self.log_view.append("🔐 Guardian online. Threat matrix active."))
