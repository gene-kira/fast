...
def train_model(self, process_stats):
    self.model = RandomForestClassifier(random_state=42, n_estimators=100, max_depth=None)
    ...
    if len(features) > 0:
        ...
        logging.warning("No valid data to train the model.")def detect_anomalies(self, process_stats=None):
    if not self.model:
        raise ValueError("Model has not been trained yet.")
    ...
    thresholds = [0.5]  # You can adjust the threshold as needed
    labels = np.where(predictions >= thresholds[0], -1, 1)  # Anomaly if proba >= threshold
...
[![Training the Model](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.jpg)](http://www.youtube.com/watch?v=YOUR_VIDEO_ID)

## Detecting Anomalies in Process Statistics

[![Detecting Anomalies](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.jpg)](http://www.youtube.com/watch?v=YOUR_VIDEO_ID)

## Monitoring with Prometheus

[![Monitoring with Prometheus](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.jpg)](http://www.youtube.com/watch?v=YOUR_VIDEO_ID)

## Fetching and Detecting Anomalies from Multiple APIs

[![Fetching and Detecting Anomalies](https://img.youtube.com/vi/YOUR_VIDEO_ID/0.jpg)](http://www.youtube.com/watch?v=YOUR_VIDEO_ID)
