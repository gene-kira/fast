...
def start_gui():
    ...
    for i, v in enumerate(verdicts):
        lbl = tk.Label(root, text="", font=("Courier", 10), fg="white", bg="black")
        lbl.grid(row=1, column=i%3, columnspan=1)
        v.label = lbl
    ...
    log_box.grid(row=2, column=0, columnspan=3, pady=5)
    ...
    cast_btn.grid(row=3, column=0, pady=10)
    ...
    exit_btn.grid(row=3, column=2, pady=10)
