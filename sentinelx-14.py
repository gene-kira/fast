...
REQUIRED_LIBS = [
    ...
    "asyncio", "torch", "matplotlib", "cryptography"
]
...
def launch_ui():
    ...
    voice_label.pack(side="left", padx=5); voice_toggle.pack(side="left", padx=5)
    ttk.Label(voice_frame, text="Volume").pack(side="left", padx=5)
    volume_slider.pack(side="left", padx=5); voice_frame.pack(pady=10)

    tabs = ttk.Notebook(root)

    # ⛒ Trace Tab
    trace_tab = ttk.Frame(tabs); tabs.add(trace_tab, text="⛒ Trace")
